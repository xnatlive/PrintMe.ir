...
<div id="content"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <table class="form">
      <tr>
        <td><span class="text-styling"><?php echo $entry_to_name; ?> <span class="required">(*)</span></span></td>
      ...
      <tr>
        <td><span class="text-styling"><?php echo $entry_to_email; ?> <span class="required">(*)</span></span></td>
      ...
      <tr>
        <td><span class="text-styling"><?php echo $entry_from_name; ?> <span class="required">(*)</span></span></td>
      ...
      <tr>
        <td><span class="text-styling"><?php echo $entry_from_email; ?> <span class="required">(*)</span></span></td>
      ...
      <tr>
        <td><span class="text-styling"><?php echo $entry_theme; ?> <span class="required">(*)</span></span></td>
      ...
      <tr>
        <td><span class="text-styling"><?php echo $entry_message; ?></span></td>
        <td><textarea name="message" cols="40" rows="5"><?php echo $message; ?></textarea></td>
      </tr>
      <tr>
        <td><span class="text-styling"><?php echo $entry_amount; ?> <span class="required">(*)</span></span></td>
