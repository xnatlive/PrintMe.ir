...
<div id="content"><?php echo $content_top; ?>
  ...
  <table class="list">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="right"><a href="<?php echo $product['return']; ?>"><img src="catalog/view/theme/raiser/image/return.png" alt="<?php echo $button_return; ?>" title="<?php echo $button_return; ?>" /></a></td>
      </tr>
      <?php } ?>
  ...
  <?php } ?>
  <?php if ($histories) { ?>
  <h2 class ="h2-wm"><span class="heading-lines"><?php echo $text_history; ?></span></h2>
  <br/>
  <table class="list">
    <thead>
      <tr>
