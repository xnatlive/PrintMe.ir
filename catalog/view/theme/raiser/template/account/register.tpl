...
<div id="content"><?php echo $content_top; ?>
  <div class="mn-styling"><?php echo $text_account_already; ?></div>
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <h2 class ="h2-wm"><span class="heading-lines"><?php echo $text_your_details; ?></span></h2>
    <div class="mn-styling">
    <div class="content">
      <table class="form">      
        <tr>
    ...
    <h2 class ="h2-wm"><span class="heading-lines"><?php echo $text_your_address; ?></span></h2>
    <div class="mn-styling">
    <div class="content">
      <table class="form">
        <tr>
    ...
    <h2 class ="h2-wm"><span class="heading-lines"><?php echo $text_your_password; ?></span></h2>
    <div class="mn-styling">
    <div class="content">
      <table class="form">
        <tr>
    ...
    <h2 class ="h2-wm"><span class="heading-lines"><?php echo $text_newsletter; ?></span></h2>
    <div class="mn-styling">
    <div class="content">
      <table class="form">
        <tr>
