...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-filter">
    ...
    <div class="display"><span class="dplt"><?php echo $text_display; ?></span> <div class="listviewactive"><span class="lstt"><?php echo $text_list; ?></span></div><a onclick="display(\'grid\');"><div class="gridview"><span class="grdt"><?php echo $text_grid; ?></span></div></a></div>
    <div class="limit"><span class="text-styling"><?php echo $text_limit; ?></span>
    ...
    <div class="sort"><span class="text-styling"><?php echo $text_sort; ?></span>
      <select class="styled" onchange="location = this.value;">
