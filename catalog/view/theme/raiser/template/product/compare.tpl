    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php if ($products[$product['product_id']]['thumb']) { ?>
          <div class="compare-image"><img src="<?php echo $products[$product['product_id']]['thumb']; ?>" alt="<?php echo $products[$product['product_id']]['name']; ?>" /></div>
          <?php } ?></td>
        <?php } ?>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/raiser/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
